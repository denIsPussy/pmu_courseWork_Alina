...
enum class Screen (
    ...
    OrderBouquets("bouquets/{id}", R.string.boot_title, null, showInBottomBar = false, showTopBarAndNavBar = false),
    ...
    Statistics("statistics", R.string.favorite_title, R.drawable.icons8_favorite, showInBottomBar = false, showTopBarAndNavBar = false),
